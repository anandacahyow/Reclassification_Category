...
def create_pareto(df, category_column, value_column, duration_type):
    ...
    category_colors = {
        "Production Time": "#91C483",
        "Unplanned Stoppages": "#FF6464",
        "Not Occupied": "#EEEEEE",
        "Planned Stoppages": "#FFE162"
    }
...
def create_waterfall(df, category_column1, category_column2, value_column, duration_type):
    ...
    fig = go.Figure(go.Waterfall(
        ...
        increasing=dict(marker=dict(color="2C4E80")),  # Set color for increasing values
        decreasing=dict(marker=dict(color="FFC55A")),  # Set color for decreasing values
...
def main():
    ...
    url = "https://github.com/ai-coordinator/Video-transmission"
