...
def main():
    ...
    if uploaded_file is not None:
        ...
        # Create time inputs for filtering by time
        start_time = st.time_input("Start Time", value=pd.Timestamp("00:00").time())
        end_time = st.time_input("End Time", value=pd.Timestamp("23:59:59").time())
